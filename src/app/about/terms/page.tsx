export default function Terms() {
  return (
    <div className="w-full md:w-1/2 mx-auto">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to RANSAN FARMS AND FOODS, No-458/12A,
            Meenatchipuram Batlagundu to Usilampatti Main Road, Batlagundu,
            Dindigul, Nilakottai block, Dindigul, Tamil Nadu-624202.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to RanSan Farms and Foods,
            accessible from{" "}
            <a
              href="https://www.ransanfarms.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.ransanfarms.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: sales@ransanfarms.ccom</li>
      </ul>
    </div>
  );
}
